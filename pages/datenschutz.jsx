    ...
    return (
        <>
            ...
            <MainContainer width="container p-16">
                ...
                <div className="datenschutz col-span-12 relative text">
                    <h1 className="text-3xl font-bold lg:text-5xl mb-4 lg:mb-6">Datenschutzerklärung</h1>
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m14">
                        Einleitung
                    </h2>
                    <p>
                    ...
                    <p>Stand: 18. November 2022</p>
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4">Inhaltsübersicht</h2>{" "}
                    <ul className="index">
                        <li>
                    ...
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m3">
                        Verantwortlicher
                    </h2>
                    <p>
                        Marc Werner
                    ...
                    Vertretungsberechtigte Personen: <p>Marc Werner</p>
                    E-Mail-Adresse:{" "}
                    <p>
                        <a href="mailto:contact@sabocon.com">contact@sabocon.com</a>
                    </p>
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="mOverview">
                        Übersicht der Verarbeitungen
                    </h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m27">
                        Sicherheitsmaßnahmen
                    </h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m25">
                        Übermittlung von personenbezogenen Daten
                    </h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m24">
                        Datenverarbeitung in Drittländern
                    </h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m12">
                        Löschung von Daten
                    </h2>
                    <p>
                        ...
                        gesetzlich zulässige Zwecke erforderlich sind, wird deren Verarbeitung auf diese Zwecke
                        beschränkt. D.h., die Daten werden gesperrt und nicht für andere Zwecke verarbeitet. Das gilt
                        z.B. für Daten, die aus handels- oder steuerrechtlichen Gründen aufbewahrt werden müssen oder
                        deren Speicherung zur Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen oder zum
                    ...
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m134">
                        Einsatz von Cookies
                    </h2>
                    <p>
                    ...
                    <p>
                        ...
                        ihren Widerspruch auch über die Einstellungen ihres Browsers erklären, z.B. durch Deaktivierung
                    ...
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m317">
                        Geschäftliche Leistungen
                    </h2>
                    <p>
                    ...
                    <p>
                        ...
                        ordnungsgemäßen und betriebswirtschaftlichen Geschäftsführung sowie an Sicherheitsmaßnahmen zum
                        Schutz unserer Vertragspartner und unseres Geschäftsbetriebes vor Missbrauch, Gefährdung ihrer
                        Daten, Geheimnisse, Informationen und Rechte (z.B. zur Beteiligung von Telekommunikations-,
                        ...
                        vorgenannten Zwecke oder zur Erfüllung gesetzlicher Pflichten erforderlich ist. Über weitere
                        Formen der Verarbeitung, z.B. zu Marketingzwecken, werden die Vertragspartner im Rahmen dieser
                    ...
                    <p>
                        ...
                        werden müssen. Die gesetzliche Aufbewahrungsfrist beträgt bei steuerrechtlich relevanten
                        Unterlagen sowie bei Handelsbüchern, Inventaren, Eröffnungsbilanzen, Jahresabschlüssen, die zum
                        Verständnis dieser Unterlagen erforderlichen Arbeitsanweisungen und sonstigen
                        Organisationsunterlagen und Buchungsbelegen zehn Jahre sowie bei empfangenen Handels- und
                        Geschäftsbriefen und Wiedergaben der abgesandten Handels- und Geschäftsbriefe sechs Jahre. Die
                        Frist beginnt mit Ablauf des Kalenderjahres, in dem die letzte Eintragung in das Buch gemacht,
                        das Inventar, die Eröffnungsbilanz, der Jahresabschluss oder der Lagebericht aufgestellt, der
                        Handels- oder Geschäftsbrief empfangen oder abgesandt worden oder der Buchungsbeleg entstanden
                        ist, ferner die Aufzeichnung vorgenommen worden ist oder die sonstigen Unterlagen entstanden
                        sind.
                    </p>
                    <p>
                    ...
                    <ul className="m-elements">
                        ...
                        <li>
                            <strong>Zwecke der Verarbeitung:</strong> Erbringung vertraglicher Leistungen und
                        ...
                        <li>
                            ...
                            Abs. 1 S. 1 lit. b) DSGVO); Rechtliche Verpflichtung (Art. 6 Abs. 1 S. 1 lit. c) DSGVO);
                            Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).
                        </li>
                    </ul>
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m326">
                        Zahlungsverfahren
                    </h2>
                    <p>
                    ...
                    <p>
                        ...
                        TANs und Prüfsummen sowie die Vertrags-, Summen- und empfängerbezogenen Angaben. Die Angaben
                        sind erforderlich, um die Transaktionen durchzuführen. Die eingegebenen Daten werden jedoch nur
                        durch die Zahlungsdienstleister verarbeitet und bei diesen gespeichert. D.h., wir erhalten keine
                        konto- oder kreditkartenbezogenen Informationen, sondern lediglich Informationen mit Bestätigung
                        ...
                        Identitäts- und Bonitätsprüfung. Hierzu verweisen wir auf die AGB und die Datenschutzhinweise
                    ...
                    <ul className="m-elements">
                        <li>
                            <strong>PayPal: </strong>Zahlungsdienstleistungen (technische Anbindung von
                            Online-Bezahlmethoden) (z.B. PayPal, PayPal Plus, Braintree);{" "}
                            <strong>Dienstanbieter:</strong> PayPal (Europe) S.à r.l. et Cie, S.C.A., 22-24 Boulevard
                            Royal, L-2449 Luxembourg; <strong>Rechtsgrundlagen:</strong> Vertragserfüllung und
                    ...
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m225">
                        Bereitstellung des Onlineangebotes und Webhosting
                    </h2>
                    <p>
                    ...
                    <ul className="m-elements">
                        <li>
                            ...
                            Software, die wir von einem entsprechenden Serveranbieter (auch &quot;Webhoster&quot;
                            genannt) mieten oder anderweitig beziehen; <strong>Rechtsgrundlagen:</strong> Berechtigte
                            Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO).
                        </li>
                        <li>
                            <strong>Erhebung von Zugriffsdaten und Logfiles: </strong>Der Zugriff auf unser
                            Onlineangebot wird in Form von so genannten &quot;Server-Logfiles&quot; protokolliert. Zu
                            den Serverlogfiles können die Adresse und Name der abgerufenen Webseiten und Dateien, Datum
                            ...
                            1 lit. f) DSGVO); <strong>Löschung von Daten:</strong> Logfile-Informationen werden für die
                            Dauer von maximal 30 Tagen gespeichert und danach gelöscht oder anonymisiert. Daten, deren
                            weitere Aufbewahrung zu Beweiszwecken erforderlich ist, sind bis zur endgültigen Klärung des
                            jeweiligen Vorfalls von der Löschung ausgenommen.
                        </li>
                    </ul>
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m182">
                        Kontakt- und Anfragenverwaltung
                    </h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m237">
                        Gewinnspiele und Wettbewerbe
                    </h2>
                    <p>
                    ...
                    <p>
                        Falls im Rahmen der Gewinnspiele Beiträge der Teilnehmer veröffentlicht werden (z.B. im Rahmen
                        einer Abstimmung oder Präsentation der Gewinnspielbeiträge bzw. der Gewinner oder der
                        Berichterstattung zum Gewinnspiel), weisen wir darauf hin, dass die Namen der Teilnehmer in
                        diesem Zusammenhang ebenfalls veröffentlicht werden können. Die Teilnehmer können dem jederzeit
                        widersprechen.
                    </p>
                    <p>
                        ...
                        Fällen weisen wir darauf hin, dass wir für die im Rahmen des Gewinnspiels mitgeteilten Angaben
                        der Teilnehmer verantwortlich sind und Anfragen im Hinblick auf das Gewinnspiel an uns zu
                        richten sind.
                    </p>
                    <p>
                        ...
                        Rückfragen zum Gewinnspiel zu rechnen ist. Grundsätzlich werden die Daten der Teilnehmer
                        spätestens 6 Monate nach Ende des Gewinnspiels gelöscht. Daten der Gewinner können länger
                        einbehalten werden, um z.B. Rückfragen zu den Gewinnen beantworten oder die Gewinnleistungen
                        erfüllen zu können; in diesem Fall richtet sich die Aufbewahrungsdauer nach der Art des Gewinns
                        und beträgt z.B. bei Sachen oder Leistungen bis zu drei Jahre, um z.B. Gewährleistungsfälle
                        bearbeiten zu können. Ferner können die Daten der Teilnehmer länger gespeichert werden, z.B. in
                    ...
                    <ul className="m-elements">
                        <li>
                            ...
                            (z.B. Eingaben in Onlineformularen); Meta-/Kommunikationsdaten (z.B. Geräte-Informationen,
                            IP-Adressen).
                        </li>
                        <li>
                    ...
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m328">
                        Plugins und eingebettete Funktionen sowie Inhalte
                    </h2>
                    <p>
                    ...
                    <p>
                        ...
                        und unter anderem technische Informationen zum Browser und zum Betriebssystem, zu verweisenden
                    ...
                    <ul className="m-elements">
                        <li>
                            <strong>Google Fonts (Bezug vom Google Server): </strong>Bezug von Schriften (und Symbolen)
                            zum Zwecke einer technisch sicheren, wartungsfreien und effizienten Nutzung von Schriften
                            und Symbolen im Hinblick auf Aktualität und Ladezeiten, deren einheitliche Darstellung und
                            Berücksichtigung möglicher lizenzrechtlicher Beschränkungen. Dem Anbieter der Schriftarten
                            wird die IP-Adresse des Nutzers mitgeteilt, damit die Schriftarten im Browser des Nutzers
                            zur Verfügung gestellt werden können. Darüber hinaus werden technische Daten
                            ...
                            Schriftarten in den USA verarbeitet werden; <strong>Dienstanbieter:</strong> Google Ireland
                    ...
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m15">
                        Änderung und Aktualisierung der Datenschutzerklärung
                    </h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m10">
                        Rechte der betroffenen Personen
                    </h2>
                    <p>
                    ...
                    <h2 className="text-xl font-bold lg:text-2xl mb-4 lg:mb-6 mt-4" id="m42">
                        Begriffsdefinitionen
                    </h2>
                    <p>
                    ...
                    <ul className="glossary">
                        <li>
                            ...
                            wie einem Namen, zu einer Kennnummer, zu Standortdaten, zu einer Online-Kennung (z.B.
                            Cookie) oder zu einem oder mehreren besonderen Merkmalen identifiziert werden kann, die
