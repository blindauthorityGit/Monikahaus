...
const Kugel = (props, ref) => {
    ...
    return (
        ...
        >
            ...
            <ToolTip
                klasse={`absolute tooltip  hidden z-20 sm:right-[${props.abstand}rem] bg-black py-2 sm:py-6 px-4 sm:px-8 min-w-[8rem] sm:min-w-[20rem] sm:font-bold rounded-xl ${props.toolTipColor} ${props.toolTipAfterColor}`}
                name={props.fullName}
                sum={props.sum}
